...
if __name__ == '__main__':
    hps = Hps()
    hps.load('./hps/v16.json')
    hps_tuple = hps.get_tuple()
    dataset = myDataset('/storage/raw_feature/voice_conversion/vctk/norm_vctk.h5',\
            '/storage/raw_feature/voice_conversion/vctk/128_513_2000k.json')
    data_loader = DataLoader(dataset)
    solver = Solver(hps_tuple, data_loader)
    solver.load_model('/storage/model/voice_conversion/ae/model_tanh.pkl-49999')
